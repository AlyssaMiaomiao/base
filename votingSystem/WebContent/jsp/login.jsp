		...
		<div class="login">
			...
			<form method="post" action="${pageContext.request.contextPath}/doLogin">
				<dl id="loginBox">
					...
					<dt>密　码：</dt>
					<dd><input type="password" class="input-text" name="pwd"  /></dd>
					<dt></dt>
					<dd><input type="checkbox"  name="remember"  value="1"/>10天内免登录</dd>
					<dt></dt>
					<dd><input type="submit" class="input-button" name="submit" value="登录" /> <a href="${pageContext.request.contextPath}/register.jsp">新用户注册</a></dd>
				</dl>
			</form>
